...
| **应用体积** | **109 MB** (自带17款字体) | 482 MB | 46 MB (依附系统WebKit) | 367 MB | 932 MB |
| **操作系统进程** | **1 个原生进程** | 4 个独立进程 | 2 个独立进程 | 5 个独立进程 | 8+ 个独立进程 |
| **冷启动首帧** | **~200 ms** | 1,500 ~ 2,500 ms | 450 ~ 600 ms | 1,800 ~ 3,000 ms | 1,800 ~ 3,500 ms |
| **20KB PRD 渲染** | **0.88 ms** | 350 ~ 450 ms | 300 ~ 400 ms | 450 ~ 600 ms | 500 ~ 700 ms |
| **100KB 书籍排版** | **2.81 ms** (30+页纯矢量) | 750 ~ 1,000 ms | 600 ~ 800 ms | 1,000 ~ 1,500 ms | 1,200 ~ 2,000 ms |
