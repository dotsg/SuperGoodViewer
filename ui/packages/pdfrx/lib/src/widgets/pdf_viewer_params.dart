...
class PdfViewerParams {
  const PdfViewerParams({
    ...
    this.onViewerReady,
    this.enableTiledRendering = false,
    this.onVisiblePagesRendered,
  ...
  /// Use stable physical-pixel tiles and prefetch them outside the viewport.
  final bool enableTiledRendering;

  /// Reports whether the visible PDF content has been painted at screen resolution.
  /// Unlike onViewerReady, this waits for the raster images, including after scrolling.
  final ValueChanged<bool>? onVisiblePagesRendered;
  ...
  bool doChangesRequireReload(PdfViewerParams? other) {
    return other == null ||
        ...
        other.enableTiledRendering != enableTiledRendering ||
  ...
  bool operator ==(covariant PdfViewerParams other) {
    ...
    return other.margin == margin &&
        ...
        other.enableTiledRendering == enableTiledRendering &&
        other.onVisiblePagesRendered == onVisiblePagesRendered &&
  ...
  int get hashCode {
    return margin.hashCode ^
        ...
        enableTiledRendering.hashCode ^
        onVisiblePagesRendered.hashCode ^
